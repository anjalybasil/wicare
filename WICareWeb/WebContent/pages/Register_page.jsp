										...
										<div class="shopping_cart dropdown">
												...
												<div class="animated_item">
													...
													<div class="clearfix sc_product">
														...
														<a href="#" class="product_thumb"><img src="${pageContext.request.contextPath}/images/sc_img_1.jpg" alt=""></a>
												...
												<div class="animated_item">
													...
													<div class="clearfix sc_product">
														...
														<a href="#" class="product_thumb"><img src="${pageContext.request.contextPath}/images/sc_img_2.jpg" alt=""></a>
												...
												<div class="animated_item">
													...
													<div class="clearfix sc_product">
														...
														<a href="#" class="product_thumb"><img src="${pageContext.request.contextPath}/images/sc_img_3.jpg" alt=""></a>
								...
								<ul>
									...
									<li class="row">	
										...
										<div class="col-xs-12">
											...
											<input type="text"  id="address" name ="address_line1" >
									...
									<li class="row">
										...
										<div class="col-xs-12">
                                          ...
                                          <input type="text"  id="addres2" name ="address_line2">
									...
									<li class="row">
									  ...
									  <div class="col-xs-6">
											...
											<input type="radio" checked name="ship" id="radio_1" name="is_wic">
									...
									<li class="row">
									  <div class="col-sm-6">
									    ...
									    <input type="text" name="wic_acctno" id="WIC_Account" >
								      </div>
									</li>
									<li class="row"> </li>
									<!--/ .row -->
